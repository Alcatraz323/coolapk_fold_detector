...
import io.alcatraz.ccd.Easter
import io.alcatraz.ccd.R
import io.alcatraz.ccd.adapters.AuthorAdapter
import io.alcatraz.ccd.adapters.QueryElementAdapter
import io.alcatraz.ccd.beans.AuthorElement
import io.alcatraz.ccd.databinding.DialogOpsBinding
import io.alcatraz.ccd.extended.CompatWithPipeActivity
import io.alcatraz.ccd.utils.PackageCtlUtils
...
class AboutActivity : CompatWithPipeActivity() {
    ...
    private fun initData() {
        ...
        data = mutableListOf(
            AuthorElement(getString(R.string.au_l_1), BuildConfig.VERSION_NAME),
